...
\caption[Prediction examples from standard overall model.]{Prediction examples from standard overall model. The relations on the top of each box are the true relations while the remain ones are the predicted relation.}
...
\caption[Prediction examples from hybrid overall model.]{Prediction examples from hybrid overall model. The relations on the top of each box are the true relations while the remain ones are the predicted relation.}
